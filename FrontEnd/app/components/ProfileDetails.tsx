  ...
  return (
    <View className="w-full items-center relative p-4  ">
      ...
      >
        ...
        >
          ...
          <Text className="text-black font-bold text-lg">
            Ler QR-Code da sua fatura
          </Text>
        </TouchableOpacity>
        <Text className="text-convento-500 font-light text-center pl-7 pr-7  ">
          Acumula pontos por cada compra efetuada nas lojas aderentes de Tomar
        </Text>
        <Text className="text-convento-500 font-semibold text-lg text-center pb-3">
      ...
      <View className="bg-convento-100 mt-5 rounded-md border-2 border-convento-400 w-[27rem] h-[5rem] flex-row">
        <Image
          className="size-16 bg-convento-200 rounded-lg mt-1 ml-2"
          source={images.emailImg}
          accessibilityElementsHidden={true}
          importantForAccessibility="no-hide-descendants"
        ></Image>
        <View className="flex-column">
          <Text className="text-convento-500 font-light ml-2 mt-2">
            Endereço de E-mail
          </Text>
